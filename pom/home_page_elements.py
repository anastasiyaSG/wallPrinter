class HomePage:
    def __init__(self, page):
        ...
        self.logo_button = page.get_by_label("WPL")
        ...
        self.generator = page.get_by_label("main menu").get_by_role("link", name="Генератор")
        self.decoration = page.get_by_role("link", name="Декорация", exact=True)
